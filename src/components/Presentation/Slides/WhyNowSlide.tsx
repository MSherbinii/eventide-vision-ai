...
const WhyNowSlide = () => {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-background via-muted/20 to-background p-6 flex flex-col">
      {/* Header */}
      <motion.div
      ...
      >
        <Badge variant="outline" className="mb-3 font-heading text-xs border-accent text-accent">
          MARKET TIMING
        </Badge>
        <h1 className="font-heading font-bold text-3xl mb-3 text-foreground">
        ...
        >
          ...
          <div className="relative mb-8">
            <div className="flex justify-between items-center mb-4">
              ...
              <span className="text-xl font-heading font-bold text-accent">NOW</span>
            ...
            <div className="relative h-2 bg-muted rounded-full mb-6">
              ...
              <motion.div
                ...
                className="absolute left-3/4 top-1/2 transform -translate-y-1/2 w-3 h-3 bg-accent rounded-full border-2 border-background shadow-lg"
              />
            </div>
          </div>
            ...
            {timingFactors.map((factor, index) => (
              ...
              >
                <div className={`inline-flex items-center justify-center w-8 h-8 rounded-full ${factor.color} mb-3`}>
                  <factor.icon className="w-4 h-4 text-primary-foreground" />
                </div>
                
                <h3 className="font-heading font-semibold text-sm mb-2 text-foreground">
                  {factor.title}
                </h3>
          ...
          <motion.div
            ...
            className="mt-8 text-center bg-gradient-to-r from-accent/10 to-warning/10 border border-accent/20 rounded-lg p-4"
          >
